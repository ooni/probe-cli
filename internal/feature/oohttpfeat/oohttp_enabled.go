...
type HTTPRequest = oohttp.Request

// ExpectedForceAttemptHTTP2 is the expected value returned by GetForceAttemptHTTP2.
const ExpectedForceAttemptHTTP2 = true

// NewHTTPTransport creates a new [*HTTPTransport] instance.
func NewHTTPTransport() *HTTPTransport {
	txp := &HTTPTransport{&oohttp.StdlibTransport{Transport: oohttp.DefaultTransport.(*oohttp.Transport).Clone()}}
