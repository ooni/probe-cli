...
type InputProcessorExperiment interface {
	Measure(ctx context.Context, input model.RicherInput) (*model.Measurement, error)
}
...
type InputProcessorExperimentWrapper interface {
	Measure(ctx context.Context, input model.RicherInput, idx int) (*model.Measurement, error)
}
...
func (ipew inputProcessorExperimentWrapper) Measure(
	ctx context.Context, input model.RicherInput, idx int) (*model.Measurement, error) {
	return ipew.exp.Measure(ctx, input)
}
