	...
	var testcases = []testspec{{
		...
		expect: []buildtooltest.ExecExpectations{{
			...
			Env: []string{
				...
				"CC=" + fakeBinPath + "/armv7a-linux-androideabi21-clang",
				"CFLAGS=-fdata-sections -ffunction-sections -fstack-protector-strong -funwind-tables -no-canonical-prefixes -D_FORTIFY_SOURCE=2 -fpic -mthumb -Oz -DANDROID",
				"CXX=" + fakeBinPath + "/armv7a-linux-androideabi21-clang++",
			...
			Env: []string{
				...
				"CC=" + fakeBinPath + "/aarch64-linux-android21-clang",
				"CFLAGS=-fdata-sections -ffunction-sections -fstack-protector-strong -funwind-tables -no-canonical-prefixes -D_FORTIFY_SOURCE=2 -fpic -O2 -DANDROID",
				"CXX=" + fakeBinPath + "/aarch64-linux-android21-clang++",
			...
			Env: []string{
				...
				"CC=" + fakeBinPath + "/i686-linux-android21-clang",
				"CFLAGS=-fdata-sections -ffunction-sections -fstack-protector-strong -funwind-tables -no-canonical-prefixes -D_FORTIFY_SOURCE=2 -fPIC -O2 -DANDROID -mstackrealign",
				"CXX=" + fakeBinPath + "/i686-linux-android21-clang++",
...
func TestAndroidBuildCdepsOpenSSL(t *testing.T) {
	...
	var testcases = []testspec{{
		...
		expect: []buildtooltest.ExecExpectations{{
			...
			Env: []string{
				"ANDROID_NDK_HOME=Android/sdk/ndk/25.1.7654321",
				"CXXFLAGS=-fdata-sections -ffunction-sections -fstack-protector-strong -funwind-tables -no-canonical-prefixes -D_FORTIFY_SOURCE=2 -fpic -mthumb -Oz -DANDROID -Wno-macro-redefined",
				"ANDROID_HOME=Android/sdk",
				"CFLAGS=-fdata-sections -ffunction-sections -fstack-protector-strong -funwind-tables -no-canonical-prefixes -D_FORTIFY_SOURCE=2 -fpic -mthumb -Oz -DANDROID -Wno-macro-redefined",
			...
			Env: []string{
				"ANDROID_NDK_HOME=Android/sdk/ndk/25.1.7654321",
				"CXXFLAGS=-fdata-sections -ffunction-sections -fstack-protector-strong -funwind-tables -no-canonical-prefixes -D_FORTIFY_SOURCE=2 -fpic -O2 -DANDROID -Wno-macro-redefined",
				"ANDROID_HOME=Android/sdk",
				"CFLAGS=-fdata-sections -ffunction-sections -fstack-protector-strong -funwind-tables -no-canonical-prefixes -D_FORTIFY_SOURCE=2 -fpic -O2 -DANDROID -Wno-macro-redefined",
				"ANDROID_NDK_ROOT=Android/sdk/ndk/25.1.7654321",
				"PATH=" + fakeBinPath + ":" + os.Getenv("PATH"),
			},
			Argv: []string{
			...
			Env: []string{
				"ANDROID_NDK_HOME=Android/sdk/ndk/25.1.7654321",
				"CXXFLAGS=-fdata-sections -ffunction-sections -fstack-protector-strong -funwind-tables -no-canonical-prefixes -D_FORTIFY_SOURCE=2 -fPIC -O2 -DANDROID -mstackrealign -Wno-macro-redefined",
				"ANDROID_HOME=Android/sdk",
				"CFLAGS=-fdata-sections -ffunction-sections -fstack-protector-strong -funwind-tables -no-canonical-prefixes -D_FORTIFY_SOURCE=2 -fPIC -O2 -DANDROID -mstackrealign -Wno-macro-redefined",
				"ANDROID_NDK_ROOT=Android/sdk/ndk/25.1.7654321",
				"PATH=" + fakeBinPath + ":" + os.Getenv("PATH"),
			},
			Argv: []string{
