...
// 2021-02-23 10:10:06.510787 +0100 CET m=+0.000216683
...
func (api *PsiphonConfigAPI) cloneWithToken(token string) *PsiphonConfigAPI {
...
func (api *TorTargetsAPI) cloneWithToken(token string) *TorTargetsAPI {
	out := &TorTargetsAPI{}
	out.BaseURL = api.BaseURL
	out.HTTPClient = api.HTTPClient
	out.JSONCodec = api.JSONCodec
