...
var Ports = []string{
	...
	"445",   // udp
	"135",   // udp - Microsoft RPC services
	...
	"135",   // tcp - epmap | Microsoft RPC services | DCE endpoint resolution
	"3306",  // tcp
	...
	"111",   // tcp - sunrpc | portmapper, rpcbind | SUN Remote Procedure Call
	...
	"1025",  // tcp - blackjack | IIS, NFS, or listener RFS remote_file_sharing | network blackjack
	"518",   // udp - (talkd)
	"2048",  // udp
