...
func AuthenticateFlowWithSafeCookie(ctx context.Context, conn ControlTransport) error {
...
func AuthenticateWithSafeCookie(ctx context.Context, conn ControlTransport, challenge *AuthChallengeResponse) error {
