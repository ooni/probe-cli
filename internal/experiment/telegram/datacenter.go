...
func (t *Datacenter) Start(ctx context.Context) {
	t.WaitGroup.Add(1)
...
func (t *Datacenter) Run(parentCtx context.Context, index int64) {
	// create trace
...
func (t *Datacenter) urlHost(scheme string) (string, error) {
...
func (t *Datacenter) newHTTPRequest(ctx context.Context) (*http.Request, error) {
...
func (t *Datacenter) httpTransaction(ctx context.Context, network, address, alpn string,
