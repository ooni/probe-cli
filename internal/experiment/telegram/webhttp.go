...
func (t *WebHTTPTask) Start(ctx context.Context) {
	t.WaitGroup.Add(1)
...
func (t *WebHTTPTask) urlHost(scheme string) (string, error) {
...
func (t *WebHTTPTask) newHTTPRequest(ctx context.Context) (*http.Request, error) {
...
func (t *WebHTTPTask) httpTransaction(ctx context.Context, txp model.HTTPTransport,
