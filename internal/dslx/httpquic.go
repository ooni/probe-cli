...
func HTTPRequestOverQUIC(rt Runtime, options ...HTTPRequestOption) Stage[*QUICConnection, *Maybe[*HTTPResponse]] {
...
func HTTPConnectionQUIC(rt Runtime) Stage[*QUICConnection, *Maybe[*HTTPConnection]] {
