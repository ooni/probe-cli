...
func HTTPRequestOverTCP(rt Runtime, options ...HTTPRequestOption) Stage[*TCPConnection, *HTTPResponse] {
...
func HTTPConnectionTCP(rt Runtime) Stage[*TCPConnection, *HTTPConnection] {
