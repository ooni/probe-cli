...
func HTTPRequestOverTLS(rt Runtime, options ...HTTPRequestOption) Stage[*TLSConnection, *Maybe[*HTTPResponse]] {
...
func HTTPConnectionTLS(rt Runtime) Stage[*TLSConnection, *Maybe[*HTTPConnection]] {
