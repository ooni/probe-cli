...
func TestZeroTimeDNSLookupResults(t *testing.T) {
	...
	for _, tc := range cases {
		t.Run(tc.name, func(t *testing.T) {
			...
			ZeroTimeDNSLookupResults(values)
...
func TestZeroTimeNetworkEvents(t *testing.T) {
	type testcase struct {
		name     string
...
func TestZeroTimeTCPConnectResults(t *testing.T) {
	type testcase struct {
		name     string
	...
	for _, tc := range cases {
		t.Run(tc.name, func(t *testing.T) {
			...
			ZeroTimeTCPConnectResults(values)
...
func TestZeroTimeTLSHandshakeResults(t *testing.T) {
	type testcase struct {
		name     string
	...
	for _, tc := range cases {
		t.Run(tc.name, func(t *testing.T) {
			...
			ZeroTimeTLSHandshakeResults(values)
