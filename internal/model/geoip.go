...
type GeoIPASNLookupperFunc func(reader *maxminddb.Reader, ip string) (asn uint, org string, err error)
...
func (fx GeoIPASNLookupperFunc) LookupASN(ip string) (asn uint, org string, err error) {
	return fx(nil, ip) // TODO: this is experimental and we need to actually redesign this to take into account external geoip sources
}
