...
- if you need a modified default Mozilla CA pool, call `netxlite.NewDefaultCertPoolWithExtraCerts`.
If you do not need to modify the default pool and when using `netxlite`
