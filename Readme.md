...
go1.25.3) and use it for building.
...
```bash
go install -v golang.org/dl/go1.25.3@latest
$HOME/go/bin/go1.25.3 download
export GOTOOLCHAIN=local
$HOME/sdk/go1.25.3/bin/go build -v -ldflags '-s -w' ./internal/cmd/miniooni
```
