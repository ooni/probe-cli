...
go1.26.8) and use it for building.
...
```bash
go install -v golang.org/dl/go1.26.8@latest
$HOME/go/bin/go1.26.8 download
export GOTOOLCHAIN=local
$HOME/sdk/go1.26.8/bin/go build -v -ldflags '-s -w' ./internal/cmd/miniooni
```
